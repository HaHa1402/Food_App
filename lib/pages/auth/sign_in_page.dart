...
class _SignInPageState extends State<SignInPage> {
  ...
  void _loginWithFirebase() async {
    ...
    if (email.isEmpty || !GetUtils.isEmail(email)) {
      showCustomSnackBar("Vui lòng nhập email hợp lệ");
      return;
    }
    if (password.isEmpty || password.length < 6) {
      showCustomSnackBar("Mật khẩu phải từ 6 ký tự trở lên");
      return;
    }
    ...
    try {
      ...
      showCustomSnackBar(e.message ?? "Đăng nhập thất bại");
    } finally {
      setState(() {
        isLoading = false;
      });
